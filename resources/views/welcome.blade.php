  ...
  <main id="main">
      ...
      <section id="why-us" class="recent-posts" style="background: #dbd3d33b;">
          <div class="container" data-aos="fade-up">
              ...
              <div class="container aos-init aos-animate" data-aos="fade-up">
                  ...
                  <div class="row gy-5" style="justify-content: center; text-align: center">

                      <div class="col-xl-3 col-md-6 testimonial-item" data-aos="fade-up" data-aos-delay="200">
                          <a href="{{ route('marco') }}" class="readmore stretched-link"
                              style="justify-content: center;">
                              <div class="post-box">
                                  <div class="post-img">
                                      <i class="bi bi-file-earmark-medical" style="font-size: 150px"></i>
                                  </div>
                      ...
                      <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
                          <a href="{{ route('actas') }}" class="readmore stretched-link"
                              style="justify-content: center;">
                              <div class="post-box">
                                  <div class="post-img">
                                      <i class="bi bi-files" style="font-size: 150px"></i>
                                  </div>
                                  <h3 class="post-title" style="text-align: center;"><span>ACTAS</span>
                                  </h3>
              ...
              </div><!-- End Services Cards Section -->
              ...
              <div class="row gy-5">
                  ...
                  @foreach ($noticias as $noticia)
                      <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
                          <div class="post-box">
                              <div class="post-img" style="height: 170px"><img src="{{ asset($noticia->featured) }}" class="img-fluid"
                                      alt="">
                              </div>
                              <div class="meta">
                                  <span class="post-author">{{ $noticia->created_at->format('d F Y') }}
                                      {{ $noticia->created_at->format('g:i a') }}</span>
                                  <span class="post-date"> / ULTIMO</span>
                              </div>
