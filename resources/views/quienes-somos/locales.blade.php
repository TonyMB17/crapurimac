        ...
        <div class="portfolio-isotope" data-portfolio-filter="*" data-portfolio-layout="masonry" data-portfolio-sort="original-order">          
          ...
          <div class="row gy-4 portfolio-container" data-aos="fade-up" data-aos-delay="300">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
              <img src="{{asset('/assets/img/locales/muniabancay.jpg')}}" class="img-fluid" alt="">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
              <img src="{{asset('/assets/img/locales/corte.jpg')}}" class="img-fluid" alt="">
              <div class="portfolio-info">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
              <img src="{{asset('/assets/img/locales/cip.jpg')}}" class="img-fluid" alt="">
              <div class="portfolio-info">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
              <img src="{{asset('/assets/img/locales/01.jpg')}}" class="img-fluid" alt="">
              <div class="portfolio-info">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
              <img src="{{asset('/assets/img/locales/Mesa.jpg')}}" class="img-fluid" alt="">
              <div class="portfolio-info">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
              <img src="{{asset('/assets/img/locales/ct.jpg')}}" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Contraloría</h4>
                <!-- <p>Lorem ipsum, dolor sit amet consectetur</p> -->
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
              <img src="{{asset('/assets/img/locales/def.jpg')}}" class="img-fluid" alt="">
              <div class="portfolio-info">
