      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="team-member">
              <div class="member-img">
                <img src="{{asset('/assets/img/Miembros/Gobernador regional.jpg')}}" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
              ...
              <div class="member-info">
                <h4>PERCY GODOY MEDINA</h4>
                <span>Gobernador Regional de Apurímac</span>
              </div>
            </div>
          </div><!-- End Team Member --> 
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="team-member">
              <div class="member-img">
                <img src="{{asset('/assets/img/Miembros/alcalde.jpeg')}}" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
              ...
              <div class="member-info">
                <h4>Néstor Raúl Peña Sánchez</h4>
                <span>Alcalde de la Municipalidad Provincial de Abancay</span>
              </div>
            </div>
          </div><!-- End Team Member --> 
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="team-member">
              <div class="member-img">
                <img src="{{asset('/assets/img/Miembros/corte - junticia.jpeg')}}" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="team-member">
              <div class="member-img">
                <img src="{{asset('/assets/img/Miembros/Fiscales.jpg')}}" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="team-member">
              ...
              <div class="member-info">
                <h4>Dr.</h4>
                <span>Procuradora Pública Anticorrupción Descentralizada</span>
              </div>
            </div>
          </div><!-- End Team Member --> 
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="team-member">
              <div class="member-img">
                <img src="{{asset('/assets/img/Miembros/monseñor.jpeg')}}" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
              ...
              <div class="member-info">
                <h4>Mons. Gilberto Gómez González</h4>
                <span>Representante de la Iglesia Católica de Apurímac</span>
              </div>
            </div>
          </div><!-- End Team Member --> 
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="team-member">
              ...
              <div class="member-info">
                <h4>Dr. </h4>
                <span>Representante de la Iglesia Evangélica de Apurímac</span>
              </div>
            </div>
          </div><!-- End Team Member --> 
