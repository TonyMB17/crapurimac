    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Agregar Denuncia</h5>
            ...
            <div class="modal-body">
                ...
                <form action="{{route('denuncias.store')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="nombre" class="form-control" id="message-text"></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input name="correo" type="text" class="form-control" id="recipient-name">
                    </div>
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">Denunciado:</label>
                    ...
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">Testigos:</label>
