                ...
                <div class="card-body">
                    <div class="row border-bottom-success mb-4 py-4">
                        <div class="col-lg-6">
                            ...
                            <input type="email" name="email" id="recipient-name" class="form-control" required>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="border-bottom-success mb-4 py-4">
                        ...
                        <p>Respuesta a la denuncia: {{ $denuncia->created_at }}</p>
                    </div>
                    <div class="border-bottom-success mb-4 py-4">
                        <h4><strong>Mensaje:</strong></h4>
                        <textarea name="mensaje" class="form-control" id="message-text" cols="30" rows="10"></textarea>
                    </div>
                </div>
