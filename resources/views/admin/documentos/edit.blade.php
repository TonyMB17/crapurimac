<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="edit{{ $documento->id }}" tabindex="-1" role="dialog"
...
<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="delete{{ $documento->id }}" tabindex="-1" role="dialog"
    aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
